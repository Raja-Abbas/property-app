  ...
  return (
    <div>
      <div className="Investor position-relative">
        <Header />
        <div className="position-absolute z-100 bottom-0">
        <p className="text-center text-white fs-1 fw-medium font-family-Poppins  m-0 px-3 py-2">Investors</p>
        </div>
      </div>
      <div>
...
<div className="mt-5 row justify-content-center align-items-center">
    <div className="col-lg-9 justify-content-center align-items-center d-flex">
        <div className="col-md-12 row align-items-center d-flex">
            <p className="col-md-11 m-0 px-3 py-2"><span className="text-danger fs-2 fw-bold font-family-Poppins">OffSet</span><span className="text-danger fs-2 fw-medium font-family-Poppins"> </span><span className="text-danger fs-2 fw-normal font-family-Poppins">Renovation Costs with a FHA 203K Loan.</span></p>
            <p className="text-center text-dark fs-6 fw-normal font-family-Poppins col-md-12 m-0 px-3 py-2">If you are a property owner needing financing for home renovations or upgrades, an FHA 203K Renovation Loan can be used to finance the work. Backed by the Federal Housing Administration (FHA), an FHA 203K loan is a mortgage loan used to finance renovations. An FHA 203K is the best option when it comes to lowering the costs for construction.</p>
        </div>
    </div>
    <p className="text-center text-dark fs-4 fw-medium font-family-Poppins  m-0 px-3 py-2">Types of FHA Loans</p>    
    <div className="col-lg-12 gap-5 row justify-content-center">
        <div className="col-lg-5 row align-items-center">
            <p className="col-12 m-0 px-3 py-2"><span className="text-danger fs-4 fw-medium font-family-Poppins">FHA 203K </span><span className="text-danger fs-4 fw-bold font-family-Poppins">Full/Standard.</span></p>
