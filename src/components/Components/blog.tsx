...
function blog() {
  return (
    ...
    <div className="w-100 bg-danger align-items-center d-flex justify-content-center mb-4">
        <div className="px-1 align-items-center justify-content-center d-flex">
            <div className="py-1 row d-flex flex-column justify-content-center align-items-center d-flex">
                ...
                <div className="col-xl-5 row justify-content-center align-items-center">
                    ...
                    <div className="col-2">
                        <div className="px-1 py-1 rounded-5 border border-1 border-light col-12 justify-content-center align-items-center d-flex">
                            <div className="justify-content-center align-items-center">
                                <p className="text-center text-light fs-6 fw-medium font-family-Poppins col-12 m-0 px-3 py-2">Sign Up</p>
                            </div>
                        </div>
                    </div>
                </div>
