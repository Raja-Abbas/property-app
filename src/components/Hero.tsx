  ...
  return (
    <div>
      <div className="default position-relative">
               <div className="position-absolute col-3 left-0 bottom-0" style={{marginBottom:"110px"}}>
                  <img src={ChatBubble} alt="" />
                </div>
                <div className="position-absolute px-1 py-1 bg-black rounded-1 col-12 d-flex w-25 left-0 bottom-0" style={{marginBottom:"115px"}}>
                    <p className="text-center text-light fs-6 fw-semibold font-family-Poppins col-11 m-0 px-3 py-2">How can I help you?</p>
                </div>
        <HeaderNav />
        <div className="d-flex justify-content-center align-items-center h-100 m-auto">
