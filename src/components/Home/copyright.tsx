...
function copyright() {
  return (
    ...
    <div className="shadow col-xl-5 justify-content-center align-items-center d-flex">
        <p className="text-center text-dark fs-6 fw-normal font-family-Poppins col-12 m-0 px-3 py-2">© 2023 Mike Koen Realty LLC, All rights reserved. | ShoreSite Web Designs LLC</p>
    </div>
</div>
  )
}
